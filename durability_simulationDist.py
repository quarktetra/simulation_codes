...
def simulate(t_shards, p_shards, afr, d_cap, r_speed,simulation_size_scale):
    ...
    print("Please Wait: Running "+str(sim_size)+" simulations: "+str(t_shards) +" total shards with "+
        ...
        str(round(nines_th,2))+" nines. " + "; MTTDL_th_year="+str(MTTDL_th/365))
...
def main():
    ...
    DLtimes=simulate(args.number_of_total_shards, args.number_of_parity_shards, args.annual_failure_rate_in_pct, args.drive_capacity_in_TB, args.recovery_speed_in_MBps,args.simulation_size_scale)
